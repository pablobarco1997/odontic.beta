...
$idPaciente = (GETPOST('idp')!="")?GETPOST('idp'):0;

#breadcrumbs  -----------------------------------------------
$url_breadcrumbs = $_SERVER['REQUEST_URI'];
$titulo = "Ficha Clinica";
$modulo = false;
...
<div class="form-group col-xs-12 col-md-12">
    ...
    $paciente = ((getnombrePaciente($idPaciente))!="")?getnombrePaciente($idPaciente):[];

//    echo '<pre>';print_r($paciente);die();
    ...
    ?>
        ...
        <div class="row">
            <div class="col-md-6">CEDULA/PASAPORTE <input type="text" class="form-control input-sm" name="doc_cedula" id="doc_cedula" value=" <?= $paciente->ruc_ced ?>"></div>
...
<?php echo '<script src="'.DOL_HTTP .'/application/system/documentos_clinicos/js/document_ficha_clinica.js"></script>';  ?>
