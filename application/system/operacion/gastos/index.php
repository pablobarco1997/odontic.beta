...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section class="content container-fluid" id="boxContentGastos">
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h4 class="no-margin"><span><b><?= 'Gastos' ?></b></span></h4>
                </div>

                <script>
                    $boxContentGastos = $("#boxContentGastos");
                </script>
                ...
                <div class="box-body">
                    <div class="form-group form-group col-xs-12 col-md-12">
                        ...
                        accessoModule('Gastos');
                        if(isset($view)) {
                            if($view != ""){
                                include_once DOL_DOCUMENT.'/application/system/operacion/gastos/view/'.$view.'.php';
                            }
                        }
                        ?>
                    </div>
