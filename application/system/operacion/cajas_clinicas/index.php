...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section class="content container-fluid" id="boxContentCajasClinicas">
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h4 class="no-margin"><span><b><?= 'Cajas Clinicas' ?></b></span></h4>
                </div>

                <script>
                    $boxContentCajasClinicas = $("#boxContentCajasClinicas");
                </script>
