...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <section class="content container-fluid" id="boxContenTransacciones">
            <div class="box box-solid">
                <div class="box-header with-border">
                    <h4 class="no-margin"><span><b><?= 'Transacciones Clinicas' ?></b></span></h4>
                </div>

                <script>
                    $boxContenTransacciones = $("#boxContenTransacciones");
                </script>
                ...
                <div class="box-body">
                    <div class="form-group form-group col-xs-12 col-md-12">
                        <?php
                            ...
                            accessoModule('Transacciones Clinicas');
                            if(isset($view)) {
                                if($view != ""){
                                    include_once DOL_DOCUMENT.'/application/system/operacion/transacciones_clinicas/view/'.$view.'.php';
                                }
                            }
                        ?>
                    </div>
