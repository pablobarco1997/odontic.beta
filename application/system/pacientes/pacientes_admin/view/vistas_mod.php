...
switch($VISTAS)
{
    ...
    case "programa_email":
        $VIEW_GLOB_ADMIN_PACIENTES   = "programa_email";                    #view E-mail
        $DIRECTORIO_ADMIN            = "email_programar";                   #directorio
        $_JS_DOCMENT                 = "email_programad";                   #E-mail javascript
        $NAME_MODULO                 = "PROGRAMAR E-MAIL";
        break;
